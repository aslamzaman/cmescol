...
export const BtnSubmitDisabled = ({ Title }) => {
  return (
    <button type="submit" className="text-center mt-5 mx-0.5 px-4 py-1.5 font-semibold rounded-md focus:ring-1 bg-gray-300 text-gray-500 cursor-not-allowed" disabled>{Title}</button>
  )
}

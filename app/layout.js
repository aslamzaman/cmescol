...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body>
      <div className="w-full px-4 pt-2 pb-3 flex space-x-4 bg-gray-100 border-b-2 shadow-md">
        <Link href="/" className="text-gray-400 hover:text-gray-500 font-bold cursor-pointer underline underline-offset-4 decoration-4">Id Generate</Link>

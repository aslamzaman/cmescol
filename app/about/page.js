const About = () => {
    return (
        <div className="w-full bg-green-900 py-20">
            <h1 className="w-full pb-2 lg:pb-8 text-center text-3xl lg:text-6xl text-white font-bold uppercase">About Us</h1>
            <div className="w-full h-[1px] bg-gray-200"></div>
           
            <div className="w-full lg:w-3/4 px-4 mx-auto text-white">
                <p className="w-full py-6 text-justify">
